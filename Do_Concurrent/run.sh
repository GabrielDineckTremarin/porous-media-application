...
#/opt/nvidia/hpc_sdk/Linux_x86_64/23.1/compilers/bin/pgf90 -O3 -mp=gpu -Minfo=stdpar,all -stdpar=gpu \
/opt/nvidia/hpc_sdk/Linux_x86_64/23.1/compilers/bin/pgf90 -O3 -mp=multicore -Minfo=stdpar,all -stdpar=multicore \
  	comum.f90 \
properties_CH4.f90 \
       initial.f90 \

...
#line 1 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/boundary.f90"
subroutine bcUV(um,vm)
    use comum
    use omp_lib
    implicit none
      include 'boundary.f90.opari.inc'
#line 5 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/boundary.f90"
    integer :: i, j
...
SUBROUTINE bcP(pn)
    ...
    IMPLICIT NONE
      include 'boundary.f90.opari.inc'
#line 103 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/boundary.f90"
    INTEGER :: i, j
...
SUBROUTINE bcZ(Zn)
    ...
    IMPLICIT NONE
      include 'boundary.f90.opari.inc'
#line 139 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/boundary.f90"
    INTEGER :: i, j
...
SUBROUTINE bcH(H)
    ...
    IMPLICIT NONE
      include 'boundary.f90.opari.inc'
#line 196 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/boundary.f90"
    INTEGER :: i, j

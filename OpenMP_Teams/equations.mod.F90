...
#line 1 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
...
#line 6 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    integer :: i, j
...
! $omp parallel PRIVATE(i,j,fn,fs,fe,fw,df,Dn,Ds,De,Dw,dudxdx,dxdvdy,q_art,u_W,u_WW,u_E,u_EE,u_N,u_NN,u_S,u_SS,v_P,u_P&
  ...
  !$omp target teams distribute parallel do private(i,j,fn,fs,fe,fw,df,dn,ds,de,dw,dudxdx,dxdvdy,q_art,u_w,u_ww,u_e,u_ee,u_n,u_nn,u_s,u_ss,v_p,u_p&
  !$omp&,ap,aw,aww,ae,aee,an,ann,as,ass) num_teams(numthreads) thread_limit(32)
DO i=3,imax-1
    DO j=3,jmax-2
...
!$omp target teams distribute parallel do private(i) num_teams(numthreads) thread_limit(32)
DO i=2,imax
...
!$omp target teams distribute parallel do private(j) num_teams(numthreads) thread_limit(32)
!num_teams(numThreads) thread_limit(32)
DO j=2,jmax-1
...
subroutine upwind_U(um,vm,p,RU,i,j)
    ...
    implicit none
      include 'equations.f90.opari.inc'
#line 109 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    integer :: i, j, itc
...
subroutine solve_U(um,vm,um_n,um_tau,vm_tau,um_n_tau,p,residual_u)
    ...
    implicit none
      include 'equations.f90.opari.inc'
#line 173 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    integer :: i, j
...
!    REAL(8), DIMENSION(1:imax+1,1:jmax+1) ::epsilon1,Darcy
    ...
    !$omp target teams distribute parallel do private (i, j) num_teams(numthreads) thread_limit(32)
    DO i=3,imax-1
        DO j=2,jmax-1
...
subroutine solve_res_u(i,j,m,m_tau,RM,res_m)
    ...
    implicit none
      include 'equations.f90.opari.inc'
#line 256 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    integer :: i, j
...
subroutine RESV(um,vm,p,T,InvFr2,RV)
    ...
    implicit none
      include 'equations.f90.opari.inc'
#line 281 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    integer :: i, j
...
!!!!!!! $omp parallel do 
!$omp target teams distribute parallel do private(i,j,fn,fs,fe,fw,df,dn,ds,de,dw,dvdydy,dydudx,q_art,&
...
subroutine upwind_V(um,vm,p,RV,InvFr2,T,i,j)
    ...
    implicit none
      include 'equations.f90.opari.inc'
#line 394 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    integer :: i, j, itc
...
subroutine solve_V(um,vm,vm_n,um_tau,vm_tau,vm_n_tau,p,T,InvFr2,residual_v)
    ...
    implicit none
      include 'equations.f90.opari.inc'
#line 459 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    integer :: i, j
...
subroutine solve_res_v(i,j,m,m_tau,RM,res_m)
    ...
    implicit none
      include 'equations.f90.opari.inc'
#line 544 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    integer :: i, j
...
function alpha(x)
    implicit none
      include 'equations.f90.opari.inc'
#line 563 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    real(8) :: alpha, x
...
SUBROUTINE quick(ap,aw,aww,ae,aee,an,ann,as,ass,fw,fe,fn,fs,df,Dw,De,Dn,Ds)
   ...
   IMPLICIT NONE
      include 'equations.f90.opari.inc'
#line 582 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
...
SUBROUTINE upwind(ap,aw,ae,an,as,fw,fe,fn,fs,df,Dw,De,Dn,Ds)
   ...
   IMPLICIT NONE
      include 'equations.f90.opari.inc'
#line 617 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    REAL(8) :: fw, fe, fs, fn, df
...
SUBROUTINE solve_P(c2,p,um_n,vm_n,pn,residual_p)
    ...
    IMPLICIT NONE
      include 'equations.f90.opari.inc'
#line 641 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    INTEGER :: i, j
...
SUBROUTINE RESP(um_n,vm_n,p,RP)
    ...
    IMPLICIT NONE
      include 'equations.f90.opari.inc'
#line 738 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    INTEGER :: i, j
    REAL(8), DIMENSION(1:imax+1,1:jmax  ) :: um_n
    REAL(8), DIMENSION(1:imax  ,1:jmax+1) :: vm_n
    ...
    !!!!!! $omp parallel do 
    !$omp target teams distribute parallel do private(i,j,dudx,dvdy) num_teams(numthreads) thread_limit(32)
    do i=2,imax-1
        do j=2,jmax-1
...
SUBROUTINE solve_Z(um_n,vm_n,Z,Z_n_tau,Z_tau)
    ...
    IMPLICIT NONE
      include 'equations.f90.opari.inc'
#line 772 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    INTEGER :: i, j
    REAL(8), DIMENSION(1:imax+1,1:jmax  ) :: um_n
    REAL(8), DIMENSION(1:imax  ,1:jmax+1) :: vm_n
...
subroutine solve_res_Z(i,j,m,m_tau,RM,res_m)
    ...
    implicit none
      include 'equations.f90.opari.inc'
#line 849 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    integer :: i, j
...
SUBROUTINE RESZ(um_n,vm_n,Z,RZ)
    ...
    IMPLICIT NONE
      include 'equations.f90.opari.inc'
#line 869 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    INTEGER :: i, j
    REAL(8), DIMENSION(1:imax+1,1:jmax  ) :: um_n
    REAL(8), DIMENSION(1:imax  ,1:jmax+1) :: vm_n
    REAL(8), DIMENSION(1:imax,1:jmax) :: Z, RZ, Zi
 !   REAL(8), DIMENSION(0:imax+1,0:jmax+1) ::epsilon1
    ...
    !!!!$omp parallel do
    !$omp target teams distribute parallel do private(i,j, dzudx, dzvdy, de, dw, dn, ds, ze,zw,zn,zs,zp, dp) num_teams(numthreads) thread_limit(32) 
    do i=2,imax-1
        do j=2,jmax-1
...
SUBROUTINE solve_H(H,Z)
    ...
    IMPLICIT NONE
      include 'equations.f90.opari.inc'
#line 928 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    INTEGER :: i, j
...
SUBROUTINE comp_T(Z,H,T)
    ...
    IMPLICIT NONE
      include 'equations.f90.opari.inc'
#line 955 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/equations.f90"
    INTEGER :: i, j

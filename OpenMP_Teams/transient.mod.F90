...
#line 1 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/transient.f90"
subroutine transient(u,v,p,T,Z,tr)
    use comum
    implicit none
      include 'transient.f90.opari.inc'
#line 4 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/transient.f90"
    integer :: i, j, tr

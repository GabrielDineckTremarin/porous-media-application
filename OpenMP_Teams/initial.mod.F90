...
#line 1 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/initial.f90"
SUBROUTINE init
    USE comum
    IMPLICIT NONE
...
#line 6 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/initial.f90"
...
SUBROUTINE IC(um,vm,p,T)
    ...
    IMPLICIT NONE
      include 'initial.f90.opari.inc'
#line 24 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/initial.f90"
    INTEGER :: i, j
...
SUBROUTINE restart(um,vm,p,T)
    ...
    IMPLICIT NONE
      include 'initial.f90.opari.inc'
#line 71 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/initial.f90"
    INTEGER :: i, j
    REAL(8), DIMENSION(1:imax+1,1:jmax  ) :: um
    REAL(8), DIMENSION(1:imax  ,1:jmax+1) :: vm
...
SUBROUTINE restart_dom(um,vm,p,T,Z,H)
    ...
    IMPLICIT NONE
      include 'initial.f90.opari.inc'
#line 123 "/home/gabriel/POROUS-MEDIA-APPLICATION-main/OpenMP_Teams/initial.f90"
    INTEGER :: i, j
